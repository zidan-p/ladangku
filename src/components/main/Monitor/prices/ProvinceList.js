...
export default function ProvinceList(props){
    ...
    return (
        ...
        className="flex group justify-between rounded-sm p-2 cursor-pointer text-gray-600 hover:text-black bg-white hover:bg-gray-100 border border-gray-400 active:bg-gray-200">
            {props.name}
