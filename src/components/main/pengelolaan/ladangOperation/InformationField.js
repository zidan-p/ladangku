...
export default function InformationField() {
  return (
    <div className="flex flex-col h-5/6 justify-between p-5">
      ...
      <div>
        <h5 className="text-sm">Durasi tanam hingga panen</h5>
        <p className="text-xs text-gray-500">
          dikarenakan banyak jenis tanaman yang memiliki masa tanam yang berbeda
           dan juga bergntung padaa jenisnya, maka setiap durasi tanam bisa diinputkan
           sendiri untuk menyesuaikan tanaman.
        </p>
      </div>
    </div>
  );
